...
const DetailModalNotification = ({isVisible, onClose,selectedItem}) => {
                    ...
                    {selectedItem.pdfExists==1 && (
                        ...
                        <View style={{justifyContent: 'center'}}>
                            <TouchableOpacity>
                                ...
                                Press the PDF to download the Document:
                                </Text>
                                <Image 
                                source={icons.pdf}
                                style={{
...
export default DetailModalNotification